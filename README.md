...
支持拖入本地 DICOM 文件、文件夹和 ZIP / 7z / TAR / GZ 等压缩包，后台解压、扫描与取消；同时支持常见 JPEG、JPEG-LS、JPEG 2000、RLE 等 DICOM 像素压缩编码。窗宽 / 窗位最多保留一位小数。详见 [本地导入说明](docs/local-import.md)。上述下载链接仍对应已发布的 0.2.0，0.4.0 尚未发布安装包。
