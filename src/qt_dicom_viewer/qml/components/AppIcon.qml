...
Item {
    ...
    readonly property bool isSvgIcon: isNavigationIcon || ["annotate-text", "delete", "clear", "crop-inside", "crop-outside", "save", "window", "scroll", "pan", "zoom", "measure", "measure-line", "measure-angle", "measure-rect", "measure-ellipse", "rotate", "rotate-3d", "rotate-cw90", "rotate-ccw90", "mirror-h", "mirror-v", "mip", "annotate", "viewport-settings", "service", "mtf", "qa", "remove-bed", "volume-crop", "palette", "cine-play", "cine-pause", "reset", "export", "export-png", "export-dicom", "segmentation", "voi", "invert"].includes(iconName)
